...
from dataset_generator import variables_old  # Usa tu función "variables" existente
...
def generar_dataset_paralelo(n_muestras, Nx, Ny, dx, dy, subfolder_name=None):
    ...
    idx_validos = (T_min >= -250) & (T_max <= (T_fusion*0.5))
...
if __name__ == "__main__":
    generar_dataset_paralelo(
        ...
        dx=0.05,
        dy=0.05,
        subfolder_name="dataset_100000_test_old"
    )