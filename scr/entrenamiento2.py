...
def entrenar_modelo(X_path, Y_path, X_val_path, Y_val_path, subfolder_name, epochs, batch_size, lr, radio, alfa):
    ...
    for epoch in range(epochs):
        ...
        for X_batch, Y_batch in dataloader:
            ...
            loss = MSEcustom_batch(outputs, Y_batch, X_batch, radio, alfa, mean_X, std_X)
        ...
        with torch.no_grad():
            ...
            for X_batch_val, Y_batch_val in val_loader:
                ...
                val_loss =  MSEcustom_batch(outputs_val, Y_batch_val, X_batch_val, radio, alfa, mean_X_val, std_X_val)
